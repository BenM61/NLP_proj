...
encoded_data_train = tokenizer.batch_encode_plus(
    ...
    max_length=256, #dont really need it - its just to be safe
    return_tensors='pt'
)
...
model.to(device)
model.load_state_dict(torch.load('BERT/finetuned_BERT_epoch_1.model', map_location=torch.device('cpu')))
